...
//     // Simplified pagination state (same as KidsOnHome)
...
//     // Fetch kids products with pagination (same as KidsOnHome)
//     const fetchKidsProducts = async (page = 1, limit = 16) => {
//         setLoading(true);
//         try {
//             // Use the same API endpoint and params as KidsOnHome
...
//     // Handle page change (similar to KidsOnHome)
...
//     // Handle limit change (similar to KidsOnHome)
//     const handleLimitChange = (e) => {
//         const newLimit = parseInt(e.target.value);
//         fetchKidsProducts(1, newLimit);
//     };
...
//     // Handle product click (same as KidsOnHome)
...
//     // Generate page numbers for pagination (same as KidsOnHome)
...
//                 <br /><br />
//                 {/* Products count and items per page selector (similar to KidsOnHome) */}
...
//                 {loading ? (
//                     // Loading skeleton similar to KidsOnHome
...
//                         {/* Pagination Controls (similar to KidsOnHome) */}
...
const PublicKids = () => {
    ...
    const fetchCategories = async () => {
        try {
            ...
            // Process categories to ensure image URLs are complete
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                            {records.length > 0 ? (
                                ...
                                <div className="col-span-full text-center py-16 bg-white rounded-lg shadow">
                                    ...
                                    <h3 className="mt-4 text-lg font-medium text-gray-900">No kids products available</h3>
                                    <p className="mt-1 text-gray-600">Check back later for new items</p>
                                </div>
                            )}
                        </div>
