    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -inset-10 opacity-20">
                    <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full blur-3xl animate-pulse"></div>
                    <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-full blur-3xl animate-pulse delay-1000"></div>
                </div>
            </div>

            <div className="relative bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
                {/* Decorative header */}
                ...
                <div className="p-8">
                    ...
                    <button
                        onClick={handleback}
                        className="mb-6 text-slate-400 hover:text-amber-400 transition-colors duration-300 flex items-center group"
                    >
                        <FontAwesomeIcon icon={faArrowLeft} className="mr-2 group-hover:-translate-x-1 transition-transform duration-300" />
                        <span>Back</span>
                    </button>
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-3xl font-bold bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent tracking-wide">
                            {step === 1 ? "Forgot Password" : "Verify OTP"}
                        </h2>
                    ...
                    {step === 1 ? (
                        <div className="space-y-6">
                            ...
                            <div className="group">
                                <label
                                    htmlFor="email"
                                    className="block text-sm font-medium text-amber-300 uppercase tracking-wider mb-2 transition-all duration-300"
                                >
                                    Email Address
                                </label>
                                <div className="relative">
                                    <input
                                        type="email"
                                        id="email"
                                        className="w-full px-4 py-3 bg-slate-900/50 border-2 border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-300 backdrop-blur-sm pr-12"
                                        placeholder="Enter your email"
                                        value={email}
                                        onChange={(e) => setEmail(e.target.value)}
                                        disabled={loading}
                            ...
                            <button
                                ...
                                className={`w-full py-4 px-6 rounded-xl font-semibold text-white transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] ${
                                    loading
                                        ...
                                        : 'bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500 shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40'
                                }`}
                            >
                                {loading ? (
                                    <span className="flex items-center justify-center">
                    ...
                    <div className="text-center mt-8">
                        ...
                        <button
                            onClick={() => router.push("/login")}
                            className="text-sm text-amber-300 hover:text-amber-200 transition-colors duration-300 font-medium hover:underline"
                        >
                            Sign in
                        </button>
                    </div>
