...
//     return (
//         <div className="bg-gradient-to-b from-white to-gray-100 py-16 px-4 sm:px-8 lg:px-20 mb-16">
...
const PublicProductsOnHome = () => {
            ...
            const res = await AxiosInstance.get(
                `/api/myapp/v1/public/product/`,
                {
                    params: {
                        page: page,
                        limit: limit,
                        tags: 'Regular Products', // Filter for Regular Products
    ...
    return (
        ...
        {/* // <div className="bg-white min-h-screen mb-1 py-16 px-4 sm:px-8 lg:px-20 mb-16">
        //     <div className="max-w-screen-xl mx-auto">
