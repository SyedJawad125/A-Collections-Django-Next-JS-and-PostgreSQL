...
const ImagesCategoryCom = () => {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6 overflow-auto">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-gradient-to-br from-amber-900/20 to-amber-950/30 backdrop-blur-sm border border-amber-700/30 rounded-xl p-5 hover:border-amber-600/40 transition-all">
            ...
            <p className="text-3xl font-bold text-amber-400">{data.count}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-5 hover:border-slate-600/50 transition-all">
            ...
            <p className="text-3xl font-bold text-white">{data.current_page} / {total_pages || 1}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-yellow-900/20 to-yellow-950/30 backdrop-blur-sm border border-yellow-700/30 rounded-xl p-5 hover:border-yellow-600/40 transition-all">
            ...
            <p className="text-3xl font-bold text-yellow-400">{data.limit}</p>
          </div>
        </div>
      ...
      {/* Categories Grid - LUXURY DESIGN (UNCHANGED) */}
      {!isLoading && (
        <>
          {data.categories.length > 0 ? (
            <>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-2 border-slate-700/50 rounded-3xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]">
            ...
            <form onSubmit={saveCategory} className="p-6 space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-amber-300 uppercase tracking-wider mb-2">
                  Category Image {editingCategory && <span className="text-xs text-slate-500 normal-case tracking-normal">(Leave empty to keep current image)</span>}
                </label>
                <div className="flex items-center gap-4">
                  {/* Show current image when editing */}
                  {editingCategory && existingImage && !categoryForm.image && (
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="cursor-pointer px-6 py-3 bg-slate-800/50 hover:bg-slate-700/50 text-slate-300 hover:text-white border-2 border-slate-700/50 hover:border-amber-500/50 rounded-xl transition-all text-center">
                      {categoryForm.image ? 'Change Image' : editingCategory ? 'Change Image' : 'Upload Image'}
                      <input
                        type="file"
                        accept="image/*"
