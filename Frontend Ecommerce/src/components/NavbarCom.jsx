  ...
  return (
    <nav className={`w-full bg-gradient-to-r from-gray-900 via-black to-gray-900 backdrop-blur-md shadow-[0_3px_10px_rgba(0,0,0,0.4)] transition-all duration-300 ${
      ...
      <div className="container mx-auto flex justify-between items-center py-2 px-8">
        ...
        {/* Right Side - Shopping Cart & User Section */}
        <div className="flex items-center justify-end space-x-6">
          ...
          >
            <div className="relative flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-amber-500/20 to-yellow-600/20 hover:from-amber-500/30 hover:to-yellow-600/30 transition-all duration-300 group-hover:scale-110">
              <FontAwesomeIcon 
                icon={faShoppingCart} 
                className="text-amber-400 text-lg group-hover:text-amber-300 transition-colors duration-300" 
              />
              {cartItemCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-gradient-to-br from-red-500 to-red-600 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow-lg animate-pulse">
                  {cartItemCount}
                </span>
              )}
            </div>
            {/* Tooltip */}
            <span className="absolute top-full mt-2 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
          ...
          <div className="flex items-center">
            {loading ? (
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  {/* User Avatar */}
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-amber-400 to-yellow-600 flex items-center justify-center text-white font-semibold shadow-lg group-hover:scale-105 transition-transform duration-300 overflow-hidden ring-2 ring-amber-500/30 group-hover:ring-amber-500/50">
                    {user.profile_image ? (
                      <img
                        src={user.profile_image}
                        alt={getDisplayName()}
