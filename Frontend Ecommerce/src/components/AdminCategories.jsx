...
const CategoryCom = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black py-12 px-4 relative overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-r from-amber-500/10 to-orange-500/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-r from-yellow-500/8 to-amber-500/8 rounded-full blur-3xl animate-pulse delay-1000"></div>
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* Search and Stats Section - More Compact */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center p-4 bg-slate-900/50 rounded-xl border border-slate-800/50 mb-6 gap-3 backdrop-blur-sm">
          ...
          <div className="flex flex-col md:flex-row gap-3 w-full md:w-2/3">
            <div className="relative w-full group">
              ...
              <input
                ...
                value={searchTerm}
                onChange={handleSearch}
                className="w-full pl-10 pr-4 py-2.5 bg-slate-900/60 border-2 border-slate-700/50 text-amber-100 rounded-xl focus:border-amber-400 focus:bg-slate-900/80 focus:shadow-lg focus:shadow-amber-500/20 transition-all duration-300 outline-none backdrop-blur-sm text-sm"
              />
            </div>
            ...
            <div className="flex gap-2 items-center">
              <select 
                ...
                onChange={handleLimitChange}
                disabled={isLoading}
                className="bg-slate-900/60 border-2 border-slate-700/50 text-amber-100 rounded-xl px-3 py-2.5 focus:border-amber-400 focus:outline-none backdrop-blur-sm text-sm"
              >
                <option value="12">12 per page</option>
                <option value="24">24 per page</option>
                <option value="36">36 per page</option>
            ...
            <div className="flex items-center gap-1.5 flex-wrap justify-center">
              ...
              <div className="flex items-center gap-1">
                {getPageNumbers().map((pageNum, index) => {
                  if (pageNum === '...') {
                    return (
                      <span key={`ellipsis-${index}`} className="px-2 text-slate-500 text-sm">
                        ...
                      </span>
                    );
                  }
                  ...
                  return (
                    <button
                      ...
                      onClick={() => handlePageChange(pageNum)}
                      disabled={isLoading}
                      className={`px-2.5 py-1.5 rounded-lg transition-colors min-w-[36px] text-sm ${
                        pagination.currentPage === pageNum 
                          ? 'bg-gradient-to-r from-amber-600 to-yellow-500 text-slate-900 font-semibold shadow-lg shadow-amber-500/50' 
                          : 'bg-slate-900/60 hover:bg-slate-800 text-slate-300 border border-slate-800/50'
                      }`}
