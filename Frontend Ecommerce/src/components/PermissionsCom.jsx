...
//         const totalPages = Math.ceil(flattenedPermissions.length / pagination.limit);
...
//         // Display first page
//         updateDisplayedPermissions(1, flattenedPermissions);
//       }
//     } catch (error) {
...
//   // Update displayed permissions based on current page
//   const updateDisplayedPermissions = (page, permissions = allPermissions) => {
//     const startIndex = (page - 1) * pagination.limit;
//     const endIndex = startIndex + pagination.limit;
//     const paginatedPermissions = permissions.slice(startIndex, endIndex);
//     setPermissionsList(paginatedPermissions);
//   };
...
//       updateDisplayedPermissions(newPage);
...
//         // Remove deleted permission from allPermissions
//         const updatedPermissions = allPermissions.filter(p => p.id !== id);
//         setAllPermissions(updatedPermissions);

//         // Recalculate pagination
//         const newTotal = updatedPermissions.length;
...
//         // Update displayed permissions
//         updateDisplayedPermissions(newPage, updatedPermissions);
//       }
//     } catch (error) {
